...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    promoCodePrice = json['promocode_price'] != null ? double.parse(json['promocode_price'].toString()) : 0.0;
    userId = json['user_id'];
    vendorDiscountPrice = json['vendor_discount_price'] != null ? double.parse(json['vendor_discount_price'].toString()) : 0.0;
